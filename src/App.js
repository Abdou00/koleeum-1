    ...
    render() {
        ...
        if (error) {
            ...
            return ( <
                ...
                /> <
                Route path = "/investisseurs"
                exact component = { Proprietaires }
                /> <
                Redirect from = "/blog/investisseurs"
                to = "/investisseurs" / >
                <
                Route path = "/occupants"
                exact component = { Locataires }
                /> <
                Redirect from = "/blog/occupants"
                to = "/occupants" / >
                <
                Route path = "/qui-sommes-nous"
                exact component = { About }
                /> <
                Redirect from = "/blog/qui-sommes-nous"
                to = "/qui-sommes-nous" / >
                <
                Route path = "/Login"
                exact component = { LoginPage }
                /> <
                Redirect from = "/blog/Login"
                to = "/Login" / >
                <
                Route path = "/rgpd"
                exact component = { Rgpd }
                /> <
                Redirect from = "/blog/rgpd"
                to = "/rgpd" / >
                <
                Route path = "/mentions-legales"
                exact component = { Legal }
                /> <
                Redirect from = "/blog/mentions-legales"
                to = "/mentions-legales" / >
                <
                Route path = "/honoraires"
                exact component = { Honoraires }
                /> <
                Redirect from = "/blog/honoraires"
                to = "/honoraires" / >
                <
                Route path = "/blog"
                exact component = { Blog }
                /> <
                Redirect from = "/blog/blog"
                to = "/blog" / > { /* <Route path="/post/:id" component={Post} exact /> */ } <
                Route path = "/blog/:id"
                children = { < Article / > }
                /> <
                ...
                footerNav = { this.state.footerNav }
                ...
                style = {
                    { background: "#4270ED" } }
                buttonStyle = {
                    { backgroundColor: "#FFF", color: "#4270ED", fontSize: "16px", borderRadius: "20px", padding: "5px 25px" } }
                expires = { 150 }
                debug = { false }
